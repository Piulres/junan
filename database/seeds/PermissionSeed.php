...
class PermissionSeed extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 97, 'title' => 'monthly_report_access',],
            ['id' => 98, 'title' => 'monthly_report_create',],
            ['id' => 99, 'title' => 'monthly_report_edit',],
            ['id' => 100, 'title' => 'monthly_report_view',],
            ['id' => 101, 'title' => 'monthly_report_delete',],
            ['id' => 102, 'title' => 'internal_notification_access',],
            ['id' => 103, 'title' => 'internal_notification_create',],
            ['id' => 104, 'title' => 'internal_notification_edit',],
            ['id' => 105, 'title' => 'internal_notification_view',],
            ['id' => 106, 'title' => 'internal_notification_delete',],
            ['id' => 107, 'title' => 'team_access',],
            ['id' => 108, 'title' => 'team_create',],
            ['id' => 109, 'title' => 'team_edit',],
            ['id' => 110, 'title' => 'team_view',],
            ['id' => 111, 'title' => 'team_delete',],
